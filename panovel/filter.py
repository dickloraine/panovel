...
class PandocFilterBase():
    ...
    def run(self):
        pf.run_filter(self._pandoc_filter)
...
def run_pandoc_filter(tags=None, latex=None, html=None, other=None,
                      all_formats=None, filter_type=None, check=None):
    '''
    ...
    '''
    pandoc_filter = PandocFilter(tags, latex, html, other, all_formats, filter_type, check)
    pandoc_filter.run()
